...
class Bird extends FlappyElement {
    ...
    constructor() {
        ...
        extend_method(this, "update", (new_timestamp: DOMHighResTimeStamp) => {
        ...
        this.set_flying = (value: boolean) => { flight.held = value; }
    ...
    constructor() {
        ...
        this.render = () => {
            ...
            ctx.drawImage(
                sprites.foot,
                - sizes.foot / 2,
                this.height - sprites.foot.height,
                sizes.foot,
                sprites.foot.height
            );
            ctx.drawImage(
                ...
                sprites.top.height,
                sizes.center,
                this.height - (sprites.foot.height + sprites.top.height)
            );
            ctx.drawImage(
                sprites.top,
                - sizes.top / 2,
...
class Tunnel extends FlappyElement {
    render: () => void;
    passage: { position: number, length: number, top: number, bottom: number }
    constructor() {
        super();
        ...
        extend_method(this, "update", (time: DOMHighResTimeStamp) => {
